...
if __name__ == '__main__':
    ...
    # hits = 29507 # know no for q2

    projects = []

    for ref in tqdm(bundle_url_iterator(), total=29507):
    #     project_uuid = ref.get('metadata').get('files').get('project_json')[0].get('provenance').get('document_id')
